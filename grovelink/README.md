...
- **Up / Down** — menu wraps: **CAMERA / INBOX / REPLY / NEWS / SPECTATE / REQUESTS / CONTACTS (call/text) / STATUS / HELP / CLOSE**
...
- **2.5.0:** scrollable CONTACTS, dialogue-only Call, friend Text + auto-reply, web CJ's texts
